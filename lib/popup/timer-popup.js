...
$(function () {
  ...
  var TimerPopup = (function () {
    function TimerPopup() {
      ...
      this.$disabledText = $('#disabled-text');
    ...
    _createClass(TimerPopup, [{
      ...
      value: function bindEvents() {
        ...
        this.$resetTimer.click(function (ev) {
          return _this.onResetTimer();
        });
      }
    }, {
      ...
      value: function getActiveTabAlarmTime() {
        ...
        this.tabManager.findActiveAlarm().then(function (display) {
          ...
          _this8.$disabledText.css('display', 'none');
